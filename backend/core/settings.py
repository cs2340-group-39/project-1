...
SECRET_KEY = "django-insecure-%*d)ywl15*4cf#o*2j7td@6j$#1+1^@vre5-mfuc==)+ur!e&2"
...
EMAIL_HOST_USER = os.getenv("GOOGLE_SENDER_USERNAME")
EMAIL_HOST_PASSWORD = os.getenv("GOOGLE_SENDER_APP_PASSWORD")
EMAIL_PORT = 587
