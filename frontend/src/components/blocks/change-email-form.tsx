...
const AssociatedEmails: React.FC<AssociatedEmailsProps> = ({ emails, selectedEmail, onSelectEmail }) => {
                ...
                {emails.length > 0 ? (
                    ...
                    <div className="text-amber-600 dark:text-amber-400 mb-4 last:mb-0 flex flex-col">
                        <p className="font-medium">
                            Warning: You currently do not have any email address set up. You should really add an email
...
export function ChangeEmailForm() {
    ...
    const handleDeleteEmail = async () => {
        ...
        if (selectedEmail) {
            try {
                ...
                setAssociatedEmails((prevEmails) => prevEmails.filter((email) => email.address !== selectedEmail));
            } catch (error: any) {
    ...
    return (
        <div className="max-w-md w-full rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-black overflow-auto max-h-[75vh] z-10 relative">
            <h2 className="font-bold text-xl text-neutral-800 dark:text-neutral-200">Change your Email Address</h2>
            ...
            <h2 className="font-bold text-xl text-neutral-800 dark:text-neutral-200">Add an Email Address</h2>
